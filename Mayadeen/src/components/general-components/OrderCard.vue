        ...
        <div class="p-5 col-span-2 lg:col-span-3 flex flex-col gap-y-20">
            <div class="first-section flex justify-between relative text-lg">
                ...
                <div class="flex justify-between gap-5">
                    <router-link v-if="!isManagement" class="underline hover:underline-offset-4" to="#">
                        {{ management ? management : t("management") }}
                    </router-link>
                    <Icon v-if="isFavorite" class="text-error" height="30" icon="mdi:heart"></Icon>
                </div>
            </div>
            ...
            <div class="last-section flex justify-between">
                ...
                <div class="relative">
                    ...
                    <Icon class="text-primary absolute top-0 right-0" height="25" icon="ant-design:reload-time-outline">
                    </Icon>
                </div>
            </div>
        </div>
        <div class="img image-container left flex relative my-3 mx-3 min-h-[200px] max-h-[260px] justify-between"
            v-if="isImage">
            <img class="w-full" :src="image" alt="" />
            <Icon v-if="isSaved" class="-top-4 absolute -left-3 text-primary" icon="fontisto:favorite" width="45"
                height="57" />
        </div>
    </div>
</template>
