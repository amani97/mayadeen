...
const { data, flag, section, filterData, kinds } = storeToRefs(store);
        ...
        >
            ...
            >
                ...
                <FormSelect
                    ...
                    "
                    :value="data.real_estate_section_id"
                    :reduce="(x) => x.id"
                    v-model="data.real_estate_section_id"
                />
            </div>
            <div
                class="grid xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-6 lg:grid-cols-6 justify-center items-center"
                ...
                <FormSelect
                    :class="
                        route.path.split('/')[1] == 'dashboard'
                            ...
                            : 'col-span-2'
                    "
                    :value="data.real_estate_kind_id"
                    type="text"
                    name="kinds"
                    :options="kinds"
                    :getOptionLabel="(x) => x.name"
                    :reduce="(x) => x.id"
                    v-model="data.real_estate_kind_id"
                />
            </div>
            <div
