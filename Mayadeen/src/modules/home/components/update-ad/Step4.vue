...
onMounted(() => {
    updateData.value.description = data.value.description;
    updateData.value.advertise = data.value.advertise;
    console.log(data.value.kind_of_street);
    if (data.value.kind_of_street == "residential") {
        active[0].active = true;
        active[1].active = false;
        active[2].active = false;
    } else if (data.value.kind_of_street == "commercial") {
        active[0].active = false;
        active[1].active = true;
        active[2].active = false;
    } else if (data.value.kind_of_street == "residential_commercial") {
        active[0].active = false;
        active[1].active = false;
...
const { data, flag, kinds, filterData, updateData } = storeToRefs(store);
...
var ranges = reactive([
    {
        ...
        max: 6,
        value:
            data.value.number_of_floors === "لا يوجد"
                ? 0
                : data.value.number_of_floors,
    ...
    },
    {
        ...
        max: 6,
        value:
            data.value.num_of_rooms === "لا يوجد" ? 0 : data.value.num_of_rooms,
        key: "num_of_rooms",
    },
    {
        id: 7,
        ...
        max: 6,
        value:
            data.value.num_of_big_rooms === "لا يوجد"
                ? 0
                : data.value.num_of_big_rooms,
    ...
    },
    {
        ...
        min: 0,
        max: 6,
        value: data.value.num_of_wc === "لا يوجد" ? 0 : data.value.num_of_wc,
        key: "num_of_wc",
    },
]);
const extras = [
        ...
        <div class="grid grid-cols-1 gap-16 mb-72">
            ...
            >
                ...
                <FormInput
                    ...
                    v-maska
                    :value="Number(data.space_of_land)"
                    data-maska="################"
                    v-model.number="updateData.space_of_land"
                />
            </div>
            <div
                class="grid xl:grid-cols-4 md:grid-cols-3 items-center"
            ...
            >
                ...
                <FormInput
                    ...
                    v-maska
                    data-maska="################"
                    :value="Number(data.space_of_place)"
                    v-model.number="updateData.space_of_place"
                />
            </div>
            <div
                class="grid xl:grid-cols-4 md:grid-cols-3 items-center"
