...
import Step1 from "../../components/update-ad/Step1.vue";
import Step2 from "../../components/update-ad/Step2.vue";
import Step4 from "../../components/update-ad/Step4.vue";
import Step3 from "../../components/update-ad/Step3.vue";
...
function updateAd() {
    store
        .updateAD(route.params.realEstateId)
        .then(() => {
            route.path.split("/")[1] == "dashboard"
                ? router.push("/controlpanel")
                : router.push(
                      "/my-estate-details/" + route.params.realEstateId
                  );
        })
        .catch(() => {
            route.path.split("/")[1] == "dashboard"
...
<template>
    ...
    >
        ...
        <Form
            ...
            @submit="route.params.id == '4' ? updateAd() : nextBtn()"
